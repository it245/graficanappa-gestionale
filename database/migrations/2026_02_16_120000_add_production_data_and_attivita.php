...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('ordine_fasi') && !Schema::hasColumn('ordine_fasi', 'fogli_buoni')) {
        ...
        if (Schema::hasTable('prinect_sync_log') && !Schema::hasColumn('prinect_sync_log', 'fogli_buoni')) {
        ...
        if (Schema::hasTable('prinect_stato_macchina') && !Schema::hasColumn('prinect_stato_macchina', 'fogli_buoni')) {

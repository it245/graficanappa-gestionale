...
window.Echo = new Echo({
    broadcaster: 'reverb',
    key: '<?php echo e(config("reverb.apps.0.key", env("REVERB_APP_KEY", ""))); ?>',
    wsHost: '<?php echo e(config("reverb.servers.0.host", env("REVERB_HOST", "localhost"))); ?>',
    wsPort: <?php echo e(config("reverb.servers.0.port", env("REVERB_PORT", 8080))); ?>,
    wssPort: <?php echo e(config("reverb.servers.0.port", env("REVERB_PORT", 8080))); ?>,
    forceTLS: <?php echo e(config("reverb.servers.0.scheme", "http") === 'https' ? 'true' : 'false'); ?>,
...
<?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/partials/echo-client.blade.php ENDPATH**/ ?>
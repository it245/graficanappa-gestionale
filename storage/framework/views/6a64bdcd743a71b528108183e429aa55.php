...
<div class="header">
    ...
    <div class="header-kpis">
        <div class="hkpi hkpi-green"><div class="hkpi-val"><?php echo e($kpi['completate']); ?></div><div class="hkpi-lbl">Completate oggi</div></div>
        <div class="hkpi hkpi-blue"><div class="hkpi-val"><?php echo e($kpi['in_corso']); ?></div><div class="hkpi-lbl">In corso ora</div></div>
        <div class="hkpi hkpi-amber"><div class="hkpi-val"><?php echo e($kpi['in_coda']); ?></div><div class="hkpi-lbl">Pronte in coda</div></div>
        <div class="hkpi hkpi-purple"><div class="hkpi-val"><?php echo e($kpi['fustelle']); ?></div><div class="hkpi-lbl">Fustelle attive</div></div>
    </div>
...
<div class="zone z1">
    ...
    <?php $__currentLoopData = $macchine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="macchina <?php echo e($m['attiva'] ? 'attiva' : 'attesa'); ?>">
        <div class="m-info-left">
            <div class="m-nome"><?php echo e($m['nome']); ?></div>
            <div class="m-stato <?php echo e($m['attiva'] ? 'lav' : 'att'); ?>">● <?php echo e($m['attiva'] ? 'IN LAVORAZIONE' : 'IN ATTESA'); ?></div>
        </div>
        <div class="m-info-center">
            <?php if($m['attiva']): ?>
                <div class="m-commessa"><?php echo e($m['commessa']); ?></div>
                <div class="m-desc"><?php echo e($m['descrizione']); ?></div>
                <div class="m-cliente"><?php echo e($m['cliente']); ?></div>
            <?php else: ?>
        ...
        <div class="m-info-right">
            <?php if($m['attiva']): ?>
                <div class="m-ore"><?php echo e($m['ore_lav']); ?>h / <?php echo e($m['ore_prev']); ?>h</div>
                <?php $pct = $m['ore_prev'] > 0 ? min(round(($m['ore_lav'] / $m['ore_prev']) * 100), 100) : 0; ?>
                <div class="m-bar"><div class="m-bar-fill" style="width:<?php echo e($pct); ?>%"></div></div>
            <?php else: ?>
                <div class="m-ore">—</div>
...
<div class="zone z2">
    ...
    <?php $__currentLoopData = $prossimi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gruppo => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="coda-macchina"><?php echo e($gruppo); ?></div>
        ...
        <div class="coda-item">
            <span class="coda-num">#<?php echo e($loop->iteration); ?></span>
            <span class="coda-desc"><?php echo e($p['desc']); ?></span>
            <span class="coda-badge <?php echo e($p['badge_cls']); ?>"><?php echo e($p['badge']); ?></span>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
...
<div class="zone z3">
    ...
    <div class="obiettivo-wrap">
        <div class="obj-big">
            <span class="obj-num"><?php echo e($obiettivo['completate']); ?></span>
        </div>
        <div class="obj-stats">
            <div class="obj-stat"><div class="obj-stat-val green">+<?php echo e($obiettivo['ultima_ora']); ?></div><div class="obj-stat-lbl">Ultima ora</div></div>
            <div class="obj-stat"><div class="obj-stat-val blue"><?php echo e($kpi['in_corso']); ?></div><div class="obj-stat-lbl">In corso</div></div>
            <div class="obj-stat"><div class="obj-stat-val"><?php echo e($kpi['in_coda']); ?></div><div class="obj-stat-lbl">In coda</div></div>
            <div class="obj-stat"><div class="obj-stat-val blue"><?php echo e($obiettivo['ore']); ?>h</div><div class="obj-stat-lbl">Ore segnate</div></div>
        </div>
    </div>
</div>
...
<div class="zone z4">
    ...
    <div class="zone-header">
        ...
        <span class="zone-badge <?php echo e($mediaCls); ?>"><?php echo e($mediaPct); ?>% medio</span>
    </div>
    <?php $__currentLoopData = $utilizzo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
        $cls = $u['pct'] >= 60 ? 'green' : ($u['pct'] >= 35 ? 'orange' : 'red');
    ?>
    <div class="ore-row">
        <span class="ore-nome"><?php echo e($u['nome']); ?></span>
        <div class="ore-bar"><div class="ore-fill <?php echo e($cls); ?>" style="width:<?php echo e($u['pct']); ?>%"></div></div>
        <span class="ore-pct <?php echo e($cls); ?>"><?php echo e($u['pct']); ?>%</span>
    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
...
<div class="kiosk-page" id="page-solar" style="display:none; position:absolute; top:0; left:0; right:0; bottom:0; padding-top:inherit;">
    <div class="solar-page">
        <div class="solar-header">
            <div class="solar-title">☀️ Impianto Fotovoltaico — <?php echo e($solar['impianto_kwp'] ?? 180); ?> kWp</div>
            <div class="solar-status">
                <span class="solar-inv-badge"><?php echo e($solar['inverter_online'] ?? 0); ?>/<?php echo e($solar['inverter_totali'] ?? 7); ?> inverter online</span>
                <span class="solar-update">Agg. <?php echo e($solar['ultimo_aggiornamento'] ?? '--:--'); ?></span>
            </div>
        </div>

        <div class="solar-kpis">
            <div class="solar-kpi">
                <div class="solar-kpi-val" style="color:#fbbf24"><?php echo e($solar['oggi_kwh'] ?? 0); ?></div>
                <div class="solar-kpi-unit">kWh</div>
                <div class="solar-kpi-lbl">Produzione oggi</div>
            </div>
            <div class="solar-kpi">
                <div class="solar-kpi-val" style="color:#94a3b8"><?php echo e($solar['ieri_kwh'] ?? 0); ?></div>
                <div class="solar-kpi-unit">kWh</div>
                <div class="solar-kpi-lbl">Ieri</div>
            </div>
            <div class="solar-kpi">
                <div class="solar-kpi-val" style="color:#38bdf8"><?php echo e($solar['settimana_kwh'] ?? 0); ?></div>
                <div class="solar-kpi-unit">kWh</div>
                <div class="solar-kpi-lbl">Ultimi 7 giorni</div>
            </div>
            <div class="solar-kpi">
                <div class="solar-kpi-val" style="color:#4ade80"><?php echo e($solar['mese_kwh'] ?? 0); ?></div>
                <div class="solar-kpi-unit">kWh</div>
        ...
        <div class="solar-inverters">
            ...
            <?php $__currentLoopData = ($solar['inverter'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="solar-inv-row <?php echo e($inv['online'] ? '' : 'offline'); ?>">
                <span class="solar-inv-name"><?php echo e($inv['nome']); ?></span>
                <span class="solar-inv-tipo"><?php echo e($inv['tipo']); ?></span>
                <span class="solar-inv-kwp"><?php echo e($inv['kwp']); ?> kWp</span>
                <div class="solar-inv-bar">
                    <div class="solar-inv-fill" style="width:<?php echo e($inv['oggi_kwh_kwp'] > 0 ? min(($inv['oggi_kwh_kwp'] / 5) * 100, 100) : 0); ?>%"></div>
                </div>
                <span class="solar-inv-kwh"><?php echo e($inv['oggi_kwh']); ?> kWh</span>
                <span class="solar-inv-status"><?php echo e($inv['online'] ? '●' : '○'); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/kiosk.blade.php ENDPATH**/ ?>
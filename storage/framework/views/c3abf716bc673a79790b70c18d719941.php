...
<head>
    <meta charset="UTF-8">
    <?php if (! empty(trim($__env->yieldContent('viewport')))): ?>
        <?php echo $__env->yieldContent('viewport'); ?>
    <?php else: ?>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <?php endif; ?>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <meta name="op-token" content="<?php echo e($opToken ?? ''); ?>">
    <title><?php echo $__env->yieldContent('page-title', 'MES Grafica Nappa'); ?></title>
...
<body>
    ...
    <nav class="mes-sidebar" id="mesSidebar">
        <div class="mes-sidebar-logo">
            <img src="<?php echo e(asset('images/logo_gn.png')); ?>" alt="Logo">
            <span>MES<br>Grafica Nappa</span>
        </div>

        <?php echo $__env->yieldContent('sidebar-items'); ?>

        <div class="mes-sidebar-footer">
            v2.0 &middot; <?php echo e(now()->format('d/m/Y')); ?>
    ...
    <header class="mes-topbar" id="mesTopbar">
        <div style="display:flex; align-items:center;">
            ...
            <span class="mes-topbar-title"><?php echo $__env->yieldContent('topbar-title', 'Dashboard'); ?></span>
        </div>
        <div class="mes-topbar-right">
            ...
            <div class="mes-topbar-user">
                <div class="mes-topbar-avatar">
                    <?php echo e(strtoupper(substr($operatore->nome ?? 'U', 0, 1))); ?><?php echo e(strtoupper(substr($operatore->cognome ?? '', 0, 1))); ?>

                </div>
                <span><?php echo e($operatore->nome ?? ''); ?> <?php echo e($operatore->cognome ?? ''); ?></span>
            </div>

            <a href="<?php echo e(route('operatore.logout')); ?>" class="mes-topbar-logout">Esci</a>
        </div>
    </header>
    ...
    <?php echo $__env->make('partials.echo-client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/layouts/mes.blade.php ENDPATH**/ ?>
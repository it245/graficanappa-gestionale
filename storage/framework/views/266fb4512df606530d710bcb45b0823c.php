...
<div class="top-bar">
    <a href="<?php echo e(route('owner.dashboard')); ?>" class="btn-back">← Torna alla Dashboard</a>
</div>

<h2>Fasi Terminate<?php echo e(!empty($soloOggi) ? ' - Oggi' : ''); ?></h2>
<?php if(!empty($soloOggi)): ?>
    <a href="<?php echo e(route('owner.fasiTerminate')); ?>" class="btn btn-sm btn-outline-secondary mb-2 ms-1">Mostra tutte le fasi terminate</a>
<?php endif; ?>
...
<div class="row mx-1 mb-2">
    <div class="col-md-4">
        <div class="kpi-box">
            <h3><?php echo e($fasiTerminate->count()); ?></h3>
            <small>Totale fasi terminate</small>
        </div>
    </div>
    <div class="col-md-4">
        <div class="kpi-box">
            <h3><?php echo e($fasiTerminate->unique(function($f) { return $f->ordine->commessa ?? ''; })->count()); ?></h3>
            <small>Commesse coinvolte</small>
        </div>
    </div>
    <div class="col-md-4">
        <div class="kpi-box">
            <h3><?php echo e($fasiTerminate->filter(function($f) {
...
<div class="table-wrapper">
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $fasiTerminate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $rowClass = '';
                ...
                <tr class="<?php echo e($rowClass); ?>">
                    ...
                    <td><?php echo e($fase->priorita ?? '-'); ?></td>
                    ...
                    <td>
                        <?php $__empty_2 = true; $__currentLoopData = $fase->operatori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <?php echo e($op->nome); ?>

                            (<?php echo e($op->pivot->data_inizio ? \Carbon\Carbon::parse($op->pivot->data_inizio)->format('d/m/Y H:i') : '-'); ?>)<br>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                            -
                        <?php endif; ?>
                    </td>
                    <td><?php echo e($fase->qta_prod ?? '-'); ?></td>
                    <td><?php echo e($fase->note ?? '-'); ?></td>
                    <td><?php echo e($fase->data_inizio ?? ($fase->operatori->count() > 0 ? $fase->operatori->min('pivot.data_inizio') : '-')); ?></td>
                    <td><?php echo e($fase->data_fine ?? ($fase->operatori->count() > 0 ? $fase->operatori->max('pivot.data_fine') : '-')); ?></td>
                    <?php
                    ...
                    ?>
                    <td><?php echo e($totSecondiPausa > 0 ? sprintf('%dh %02dm', $pausaH, $pausaM) : '-'); ?></td>
                    <td>
                        <?php if($secLordo > 0): ?>
                            <?php if($oreNette >= 1): ?>
                                <?php echo e(number_format($oreNette, 1)); ?>h
                            <?php elseif($secNetto >= 60): ?>
                                <?php echo e(floor($secNetto / 60)); ?>m
                            <?php else: ?>
                                <?php echo e($secNetto); ?>s
                            <?php endif; ?>
                        <?php else: ?>
                            -
                        <?php endif; ?>
                    </td>
                    <td><span class="badge-stato"><?php echo e($fase->stato == 4 ? 'Consegnata' : 'Terminata'); ?></span></td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views\owner\fasi_terminate.blade.php ENDPATH**/ ?>
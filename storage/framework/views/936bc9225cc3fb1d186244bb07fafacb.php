...
<body>
    <div class="welcome-card">
        <img src="<?php echo e(asset('images/logo_gn.png')); ?>" alt="Logo Grafica Nappa">
        <div class="logo-text">Grafica Nappa</div>
        <div class="subtitle">Sistema Gestionale di Produzione</div>

        <a href="<?php echo e(route('operatore.login')); ?>" class="btn-enter">
            Accedi
        </a>

        <div class="footer-text">
            &copy; <?php echo e(date('Y')); ?> Grafica Nappa srl &mdash; Aversa (CE)
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/welcome.blade.php ENDPATH**/ ?>
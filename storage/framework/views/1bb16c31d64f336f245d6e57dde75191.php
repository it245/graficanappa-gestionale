...
<div class="etichetta-form no-print">
    <div class="d-flex align-items-center mb-3">
        <a href="<?php echo e(route('operatore.dashboard')); ?>" class="btn btn-outline-secondary btn-sm me-3">&larr; Dashboard</a>
        <h4 class="mb-0">Stampa Etichetta</h4>
    </div>

    <div class="mb-3">
        <label class="form-label">Cliente</label>
        <input type="text" id="campo-cliente" class="form-control" value="<?php echo e($cliente); ?>">
    </div>
    <?php if($ordine->descrizione): ?>
    <div class="alert alert-light py-2 px-3 mb-3" style="font-size:13px; border:1px solid #dee2e6;">
        <strong>Descrizione ordine:</strong> <?php echo e($ordine->descrizione); ?>

    </div>
    <?php endif; ?>

    <?php if($isItalianaConfetti): ?>
    ...
    <?php else: ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="campo-articolo-manuale" class="form-control" value="<?php echo e($articoloDefault); ?>">
        </div>
        <div class="mb-3">
            ...
            <?php if($eanSalvato): ?>
                <div class="alert alert-success py-1 px-2 mb-2" style="font-size:13px;">
                    EAN salvato: <strong><?php echo e($eanSalvato->codice_ean); ?></strong> (precompilato)
                </div>
            <?php endif; ?>
            ...
            <input type="text" id="campo-ean-manuale" class="form-control mt-2"
                   value="<?php echo e($eanSalvato->codice_ean ?? ''); ?>"
    ...
    <div class="row">
        ...
        <div class="col-4 mb-3">
            ...
            <input type="text" id="campo-lotto" class="form-control" value="<?php echo e($lotto); ?>">
        </div>
        <div class="col-4 mb-3">
            <label class="form-label">Data</label>
            <input type="text" id="campo-data" class="form-control" value="<?php echo e($data); ?>">
        </div>
    </div>
...
<div class="etichetta-preview" id="etichetta">
    <div class="header-row">
        ...
        <img src="<?php echo e(asset('images/logo_graficanappa.png')); ?>" alt="Grafica Nappa">
    </div>
    <div class="info-top">
        <div class="field"><span class="label">Cliente:</span> <span id="print-cliente"><?php echo e($cliente); ?></span></div>
    </div>
    <div class="articolo-row" id="print-articolo"></div>
    <div class="info-bottom">
        <div class="fields-left">
            <div><span class="label">Pz x cassa:</span> <span id="print-pzcassa"></span></div>
            <div><span class="label">Lotto:</span> <span id="print-lotto"><?php echo e($lotto); ?></span></div>
            <div><span class="label">Data:</span> <span id="print-data"><?php echo e($data); ?></span></div>
        </div>
        <div class="qr-right">
...
var eanData = <?php echo json_encode($eanProdotti, 15, 512) ?>;
...
function stampa() {
    ...
    if (articolo && ean) {
        fetch("<?php echo e(route('operatore.etichetta.salvaEan')); ?>", {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views\operatore\etichetta.blade.php ENDPATH**/ ?>
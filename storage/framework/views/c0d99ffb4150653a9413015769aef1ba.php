<?php $__env->startSection('viewport'); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('topbar-title', 'Dashboard Produzione'); ?>

<?php $__env->startSection('sidebar-items'); ?>
...
<div class="d-flex gap-3 mb-4 flex-wrap">
    <?php if (isset($component)) { $__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mes.kpi-card','data' => ['value' => '12','label' => 'Fasi completate oggi','color' => 'success']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mes.kpi-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => '12','label' => 'Fasi completate oggi','color' => 'success']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179)): ?>
<?php $attributes = $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179; ?>
<?php unset($__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179)): ?>
<?php $component = $__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179; ?>
<?php unset($__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179); ?>
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mes.kpi-card','data' => ['value' => '8.5h','label' => 'Ore lavorate oggi','color' => 'accent','subtitle' => 'click per dettaglio']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mes.kpi-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => '8.5h','label' => 'Ore lavorate oggi','color' => 'accent','subtitle' => 'click per dettaglio']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179)): ?>
<?php $attributes = $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179; ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mes.kpi-card','data' => ['value' => '3','label' => 'Spedite oggi','color' => 'info']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mes.kpi-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => '3','label' => 'Spedite oggi','color' => 'info']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179)): ?>
<?php $attributes = $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179; ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mes.kpi-card','data' => ['value' => '7','label' => 'Fasi in lavorazione','color' => 'warning']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mes.kpi-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => '7','label' => 'Fasi in lavorazione','color' => 'warning']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179)): ?>
<?php $attributes = $__attributesOriginal5d6bd59a81b8e1ec2c59b75fc2689179; ?>
...
<div style="width:100%; overflow-x:auto;">
    <table id="tabellaOrdini" style="white-space:nowrap;">
        ...
        <tbody>
            ...
            ?>
            <?php $__currentLoopData = $demoData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $rowClass = '';
            ...
            <tr class="<?php echo e($rowClass); ?>">
                <td><a href="#" style="color:var(--text-primary);font-weight:bold;text-decoration:underline;"><?php echo e($row[0]); ?></a></td>
                <td style="background:<?php echo e($statoBg[$row[1]] ?? '#e9ecef'); ?> !important;font-weight:bold;text-align:center;"><?php echo e($row[1]); ?></td>
                <td><?php echo e($row[2]); ?></td>
                <td><?php echo e($row[3]); ?></td>
                <td><?php echo e($row[4]); ?></td>
                <td><?php echo e($row[5]); ?></td>
                <td><?php echo e($row[6]); ?></td>
                <td style="text-align:center"><?php echo e($row[7]); ?></td>
                <td style="text-align:center"><?php echo e($row[8]); ?></td>
                <td style="text-align:center"><?php echo e($row[9]); ?></td>
                <td><?php echo e($row[10]); ?></td>
                <td><?php echo e($row[11]); ?></td>
                <td><?php echo e($row[12]); ?></td>
                <td style="text-align:center"><?php echo e($row[13]); ?></td>
                <td><?php echo e($row[14]); ?></td>
                <td><?php echo e($row[15]); ?></td>
                <td style="text-align:center;font-weight:600;color:#059669"><?php echo e($row[16]); ?></td>
                <td><?php echo e($row[17]); ?></td>
                <td style="text-align:center"><?php echo e($row[18]); ?></td>
                <td><?php echo e($row[19]); ?></td>
                <td><?php echo e($row[20]); ?></td>
                <td><?php echo e($row[21]); ?></td>
                <td><?php echo e($row[22]); ?></td>
                <td style="text-align:center"><?php echo e($row[23]); ?></td>
                <td style="text-align:center"><?php echo e($row[24]); ?></td>
                <td><?php echo e($row[25]); ?></td>
                <td style="padding:2px 4px; vertical-align:middle;">
                    <?php if (isset($component)) { $__componentOriginal9d099600e5ec62fb71aa660687929e30 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9d099600e5ec62fb71aa660687929e30 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mes.progress-bar','data' => ['percentuale' => $row[26],'avviate' => 10,'totale' => 8,'terminate' => round($row[26]*8/100)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mes.progress-bar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['percentuale' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($row[26]),'avviate' => 10,'totale' => 8,'terminate' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(round($row[26]*8/100))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d099600e5ec62fb71aa660687929e30)): ?>
<?php $attributes = $__attributesOriginal9d099600e5ec62fb71aa660687929e30; ?>
<?php unset($__attributesOriginal9d099600e5ec62fb71aa660687929e30); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9d099600e5ec62fb71aa660687929e30)): ?>
<?php $component = $__componentOriginal9d099600e5ec62fb71aa660687929e30; ?>
<?php unset($__componentOriginal9d099600e5ec62fb71aa660687929e30); ?>
<?php endif; ?>
                </td>
            </tr>
...
<?php echo $__env->make('layouts.mes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/test_ui.blade.php ENDPATH**/ ?>
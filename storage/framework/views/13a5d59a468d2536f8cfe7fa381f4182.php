...
<div class="top-bar">
    ...
    <div class="operatore-info" id="operatoreInfo">
        <img src="<?php echo e(asset('images/icons8-utente-uomo-cerchiato-50.png')); ?>" alt="Operatore">
...
<div class="sidebar-menu" id="sidebarMenu">
    ...
    <div class="sidebar-item">
        <span class="kpi-inline" style="color:#28a745;"><?php echo e($fasiDaSpedire->count()); ?></span>
        <span>Da consegnare</span>
    </div>
    <div class="sidebar-item">
        <span class="kpi-inline" style="color:#ffc107;"><?php echo e($fasiInAttesa->count()); ?></span>
        <span>In attesa</span>
    </div>
    <div class="sidebar-item">
        <span class="kpi-inline" style="color:#6f42c1;"><?php echo e($fasiDDT->count()); ?></span>
        <span>DDT Emesse</span>
    </div>
    <div class="sidebar-item">
        <span class="kpi-inline" style="color:#fd7e14;"><?php echo e($fasiParziali->count()); ?></span>
        <span>Parziali in attesa</span>
    </div>
    <div class="sidebar-item">
        <span class="kpi-inline" style="color:#198754;"><?php echo e($consegneTotali); ?></span>
        <span>Consegne totali oggi</span>
    </div>
    <div class="sidebar-item">
        <span class="kpi-inline" style="color:#fd7e14;"><?php echo e($consegneParziali); ?></span>
        <span>Consegne parziali oggi</span>
    </div>
    <hr style="margin:4px 18px;">
    <a href="<?php echo e(route('spedizione.esterne')); ?>" class="sidebar-item">
        <span class="kpi-inline" style="color:#17a2b8;"><?php echo e($fasiEsterne->count()); ?></span>
        <span>Lav. esterne</span>
    </a>
    <a href="#" class="sidebar-item" data-bs-toggle="modal" data-bs-target="#modalSpediteOggi" onclick="closeSidebar()">
        <span class="kpi-inline" style="color:#0d6efd;"><?php echo e($fasiSpediteOggi->count()); ?></span>
        <span>Consegnate oggi</span>
    </a>
    <a href="#" class="sidebar-item" data-bs-toggle="modal" data-bs-target="#modalBRT" onclick="closeSidebar()">
        <span class="kpi-inline" style="color:#d4380d;"><?php echo e($spedizioniBRT->count()); ?></span>
        <span>Spedizioni BRT</span>
    </a>
    <hr style="margin:4px 18px;">
    <a href="#" class="sidebar-item" data-bs-toggle="modal" data-bs-target="#modalStorico" onclick="closeSidebar()">
        <span class="kpi-inline" style="color:#6c757d;"><?php echo e($storicoConsegne->count()); ?></span>
...
<div class="table-wrapper">
    <table class="table table-bordered table-sm" id="tabDDT">
        ...
        <tbody>
            <?php $__currentLoopData = $fasiDDT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <tr class="searchable">
                    <td style="white-space:nowrap;">
                        <button class="btn-consegna btn-consegna-green" onclick="apriModalConsegnaDDT(<?php echo e($fase->id); ?>, 'totale')">Totale</button>
                        <button class="btn-consegna btn-consegna-orange" onclick="apriModalConsegnaDDT(<?php echo e($fase->id); ?>, 'parziale')">Parziale</button>
                    </td>
                    <td><a href="<?php echo e(route('commesse.show', $fase->ordine->commessa ?? '-')); ?>" class="commessa-link"><?php echo e($fase->ordine->commessa ?? '-'); ?></a></td>
                    <td><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
                    <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
                    <td><?php echo e($fase->ordine->descrizione ?? '-'); ?></td>
                    <td><?php echo e($qtaOrdine); ?></td>
                    <td><?php echo e($qtaDDT); ?></td>
                    <td>
                        <?php if($suggerimento === 'totale'): ?>
                    ...
                    <td style="white-space:nowrap;">
                        <?php if($isBRT && $numDDT): ?>
                            <button class="btn btn-sm btn-outline-danger fw-bold" onclick="apriTrackingDDT('<?php echo e($numDDT); ?>', this)">
                                <span class="spinner-border spinner-border-sm d-none" role="status"></span>
                                BRT Tracking
                            </button>
                        <?php elseif($vettore): ?>
                            <span class="badge bg-secondary"><?php echo e($vettore); ?></span>
                        <?php else: ?>
...
<div class="table-wrapper">
    <table class="table table-bordered table-sm table-striped" id="tabDaSpedire">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $fasiDaSpedire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $rowClass = '';
                ...
                <tr class="<?php echo e($rowClass); ?> searchable">
                    <td>
                        <button class="btn-consegna btn-consegna-green" onclick="apriModalConsegna(<?php echo e($fase->id); ?>, false)">Consegna</button>
                    </td>
                    <td>
                        <input type="text" class="form-control form-control-sm" style="min-width:150px"
                               value="<?php echo e($fase->note ?? ''); ?>"
                               onblur="aggiornaNota(<?php echo e($fase->id); ?>, this.value)">
                    </td>
                    <td><a href="<?php echo e(route('commesse.show', $fase->ordine->commessa ?? '-')); ?>" class="commessa-link"><?php echo e($fase->ordine->commessa ?? '-'); ?></a></td>
                    <td><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
                    <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
                    ...
                    <td>
                        <div class="progress-bar-custom">
                            <div class="fill" style="width:<?php echo e($pct); ?>%;background:<?php echo e($pctColor); ?>;"><?php echo e($pct); ?>%</div>
                        </div>
                    </td>
                </tr>
...
<div class="table-wrapper">
    <table class="table table-bordered table-sm" id="tabParziali">
        ...
        <tbody>
            <?php $__currentLoopData = $fasiParziali; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="searchable">
                    <td>
                        <button class="btn-consegna btn-consegna-green" onclick="apriModalConsegnaDDT(<?php echo e($fase->id); ?>, 'totale')">Consegna Totale</button>
                    </td>
                    <td><a href="<?php echo e(route('commesse.show', $fase->ordine->commessa ?? '-')); ?>" class="commessa-link"><?php echo e($fase->ordine->commessa ?? '-'); ?></a></td>
                    <td><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
                    <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
                    <td><?php echo e($fase->ordine->descrizione ?? '-'); ?></td>
                    <td><?php echo e($fase->data_fine ? \Carbon\Carbon::parse($fase->data_fine)->format('d/m/Y H:i') : '-'); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<div class="table-wrapper">
    <table class="table table-bordered table-sm" id="tabInAttesa">
        ...
        <tbody>
            <?php $__currentLoopData = $fasiInAttesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $pct = $fase->percentuale ?? 0;
                ...
                <tr class="searchable">
                    <td style="text-align:center; vertical-align:middle;">
                        <button class="btn-consegna btn-consegna-red" onclick="apriModalConsegna(<?php echo e($fase->id); ?>, true)">Consegna</button>
                        <div class="fasi-mancanti"><?php echo e($fase->fasiNonTerminate->count()); ?> fase/i aperte</div>
                    </td>
                    <td><a href="<?php echo e(route('commesse.show', $fase->ordine->commessa ?? '-')); ?>" class="commessa-link"><?php echo e($fase->ordine->commessa ?? '-'); ?></a></td>
                    <td><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
                    <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title">Consegnate oggi (<?php echo e($fasiSpediteOggi->count()); ?>)</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body" style="overflow-x:auto;">
                <?php if($fasiSpediteOggi->count() > 0): ?>
                <table class="table table-bordered table-sm" style="white-space:nowrap;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $fasiSpediteOggi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <button class="btn btn-sm btn-outline-danger fw-bold" onclick="recuperaConsegna(<?php echo e($fase->id); ?>, this)">Recupera</button>
                            </td>
                            <td><strong><?php echo e($fase->ordine->commessa ?? '-'); ?></strong></td>
                            <td><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
                            <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
                            <td><?php echo e($fase->ordine->descrizione ?? '-'); ?></td>
                            <td><?php echo e($fase->ordine->qta_richiesta ?? '-'); ?></td>
                            <td>
                                <?php if($fase->tipo_consegna === 'parziale'): ?>
                                    <span class="badge bg-warning text-dark">Parziale</span>
                                <?php else: ?>
                                    <span class="badge bg-success">Totale</span>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($fase->data_fine ? \Carbon\Carbon::parse($fase->data_fine)->format('H:i:s') : '-'); ?></td>
                            <td>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow-x:auto;">
                ...
                <?php $__currentLoopData = $storicoConsegne->groupBy(fn($f) => \Carbon\Carbon::parse($f->data_fine)->format('Y-m-d')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data => $fasiGiorno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <h6 class="mt-3 mb-2 fw-bold" style="color:#333;">
                    <?php echo e(\Carbon\Carbon::parse($data)->format('d/m/Y')); ?>
                ...
                <table class="table table-bordered table-sm mb-3" style="white-space:nowrap;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $fasiGiorno; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><strong><?php echo e($fase->ordine->commessa ?? '-'); ?></strong></td>
                            <td><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
                            <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
                            ...
                            <td><?php echo e($fase->data_fine ? \Carbon\Carbon::parse($fase->data_fine)->format('H:i') : '-'); ?></td>
                            <td>
                                <?php $__currentLoopData = $fase->operatori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($op->nome); ?> <?php echo e($op->cognome); ?><br>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function inviaConsegna(tipo) {
    ...
    fetch('<?php echo e(route("spedizione.invio")); ?>', {
...
function recuperaConsegna(faseId, btn) {
    ...
    btn.disabled = true;
    fetch('<?php echo e(route("spedizione.recupera")); ?>', {
        method: 'POST', headers: getHdrs(),
...
function apriTrackingDDT(numeroDDT, btn) {
    ...
    fetch('<?php echo e(route("spedizione.trackingByDDT")); ?>', {
        method: 'POST', headers: getHdrs(),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views\spedizione\dashboard.blade.php ENDPATH**/ ?>
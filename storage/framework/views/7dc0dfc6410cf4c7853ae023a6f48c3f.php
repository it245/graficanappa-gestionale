...
<div class="sched-header">
    ...
    <div class="header-right">
        ...
        <a href="<?php echo e(route('owner.dashboard')); ?>" class="btn-back">← Dashboard</a>
    </div>
</div>
...
<script>
const DATA = <?php echo json_encode(json_decode($dataJson), 15, 512) ?>;
const NOW = new Date();
let pxPerHour = 8;
...
const FASI_ORDINE = <?php echo json_encode(config('fasi_priorita'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views\owner\scheduling.blade.php ENDPATH**/ ?>
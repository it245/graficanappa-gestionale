...
<body>
    <div class="login-container">
        <img src="<?php echo e(asset('images/logo_gn.png')); ?>" alt="Logo Azienda">
        <h2>LOGIN</h2>

        <?php if(session('warning')): ?>
            <p class="error-message"><?php echo e(session('warning')); ?></p>
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <p class="error-message"><?php echo e($errors->first()); ?></p>
        <?php endif; ?>

        <form method="POST" action="<?php echo e(route('operatore.login.post')); ?>" onsubmit="this.querySelector('button').disabled=true; this.querySelector('button').textContent='Caricamento...';">
            <?php echo csrf_field(); ?>
    ...
    setInterval(function() {
        fetch('<?php echo e(route("operatore.login")); ?>', { credentials: 'same-origin' })
...
</html><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/operatore/login.blade.php ENDPATH**/ ?>
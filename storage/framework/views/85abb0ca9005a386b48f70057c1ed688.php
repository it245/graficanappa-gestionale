...
<div class="top-bar">
    <div style="display:flex; align-items:center; gap:10px;">
        ...
        <div class="operatore-popup" id="operatorePopup">
            ...
            <div>
                <?php if($operatore->reparti->isEmpty()): ?>
                    Nessun reparto assegnato
                <?php else: ?>
                    <p>Reparto: <strong><?php echo e($operatore->reparti->pluck('nome')->join(', ')); ?> </strong></p>
                <?php endif; ?>
            </div>
    ...
    <div class="action-icons" style="display:flex; align-items:center;">
        <img src="<?php echo e(asset('images/icons8-ricerca-50.png')); ?>"
...
<?php if(!empty($fasiPerReparto)): ?>
    
    <?php $__currentLoopData = $fasiPerReparto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repartoId => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="reparto-section">
            <h3>
                <span><?php echo e($info['nome']); ?> <small>(<?php echo e($info['fasi']->count()); ?>)</small></span>
            </h3>
            <div class="filtri-bar filtri-reparto" data-reparto="<?php echo e($repartoId); ?>">
                <label>Stato:</label>
                ...
                <table class="table table-bordered table-sm table-striped">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <?php if($showColori): ?><th>Colori</th><?php endif; ?>
                            <?php if($showFustella): ?><th>Fustella</th><?php endif; ?>
                            <?php if($showEsterno ?? false): ?><th>Esterno</th><?php endif; ?>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $info['fasi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php echo $__env->make('operatore._fase_row', ['fase' => $fase], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr><td colspan="<?php echo e(19 + ($showFustella ? 1 : 0) + ($showColori ? 1 : 0) + ($showEsterno ? 1 : 0)); ?>" class="text-center text-muted">Nessuna fase attiva</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<?php else: ?>
    ...
    <div class="table-wrapper">
        <table class="table table-bordered table-sm table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $fasiVisibili; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('operatore._fase_row', ['fase' => $fase], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasStorico" style="width:75vw; max-width:900px;">
    ...
    <div class="offcanvas-body p-0">
        <table class="table table-bordered table-sm table-striped mb-0">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $fasiTerminate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($ft->ordine->commessa ?? '-'); ?></td>
                        <td><?php echo e($ft->ordine->cliente_nome ?? '-'); ?></td>
                        <td><?php echo e($ft->fase); ?></td>
                        <td style="white-space:normal; max-width:300px;"><?php echo e(Str::limit($ft->ordine->descrizione ?? '-', 80)); ?></td>
                        <td><?php echo e($ft->data_fine ? \Carbon\Carbon::parse($ft->data_fine)->format('d/m/Y H:i') : '-'); ?></td>
                        <td>
                            <?php if($ft->ordine): ?>
                                <a href="<?php echo e(route('operatore.etichetta', $ft->ordine->id)); ?>" class="btn btn-sm btn-outline-primary" target="_blank">Stampa</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views/operatore/dashboard.blade.php ENDPATH**/ ?>
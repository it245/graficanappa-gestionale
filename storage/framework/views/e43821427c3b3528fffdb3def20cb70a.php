...
<div class="d-flex align-items-center mx-2 mb-2">
    <a href="<?php echo e(route('spedizione.dashboard')); ?>" class="btn btn-outline-secondary btn-sm me-3">&larr; Dashboard</a>
    <h2 class="mb-0" style="color:#17a2b8;">Lavorazioni Esterne (<?php echo e($fasiEsterne->count()); ?>)</h2>
</div>
...
<div class="table-wrapper">
    <table class="table table-bordered table-sm table-striped" id="tabEsterne">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $fasiEsterne; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $rowClass = '';
                ...
                <tr class="<?php echo e($rowClass); ?> searchable">
                    <td style="white-space:nowrap;">
                        <?php if($statoFase == 0 || $statoFase == 1): ?>
                            <button class="btn btn-sm btn-success fw-bold" onclick="esternoAvvia(<?php echo e($fase->id); ?>, this)">Avvia</button>
                        <?php elseif($statoFase == 2): ?>
                            <button class="btn btn-sm btn-warning fw-bold" onclick="esternoPausa(<?php echo e($fase->id); ?>, this)">Pausa</button>
                            <button class="btn btn-sm btn-danger fw-bold"
                                    data-qta-fase="<?php echo e($fase->qta_fase ?? 0); ?>"
                                    ...
                                    onclick="esternoTermina(<?php echo e($fase->id); ?>, this)">Termina</button>
                        <?php elseif($inPausa): ?>
                            <button class="btn btn-sm btn-success fw-bold" onclick="esternoRiprendi(<?php echo e($fase->id); ?>, this)">Riprendi</button>
                            <button class="btn btn-sm btn-danger fw-bold"
                                    data-qta-fase="<?php echo e($fase->qta_fase ?? 0); ?>"
                                    data-fogli-buoni="<?php echo e($fase->fogli_buoni ?? 0); ?>"
                                    data-fogli-scarto="<?php echo e($fase->fogli_scarto ?? 0); ?>"
                    ...
                    <td>
                        ...
                        <?php elseif($inPausa): ?>
                            <span class="badge bg-warning text-dark">Pausa: <?php echo e($statoFase); ?></span>
                        <?php endif; ?>
                    </td>
                    <td>
...
function confermaTerzista() {
    ...
    fetch('<?php echo e(route("produzione.avvia")); ?>', {
        method: 'POST', headers: getHdrs(),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Giovanni\graficanappa-gestionale\resources\views\spedizione\esterne.blade.php ENDPATH**/ ?>
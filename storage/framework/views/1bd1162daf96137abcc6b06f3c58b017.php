...
<tr id="fase-<?php echo e($fase->id); ?>" class="<?php echo e($rowClass); ?>">
    ...
    <td class="td-stato" id="stato-<?php echo e($fase->id); ?>" style="background:<?php echo e($statoBg[$fase->stato] ?? '#e9ecef'); ?>;font-weight:bold;text-align:center;"><?php echo e($fase->stato); ?></td>
    ...
    <td class="td-cliente"><?php echo e($fase->ordine->cliente_nome ?? '-'); ?></td>
    <td><?php echo e($fase->ordine->cod_art ?? '-'); ?></td>
    <?php if($showColori ?? false): ?><td><?php echo e($fase->colori ?? '-'); ?></td><?php endif; ?>
    <?php if($showFustella ?? false): ?><td><?php echo e($fase->fustella_codice ?? '-'); ?></td><?php endif; ?>
    <?php if($showEsterno ?? false): ?><td><?php echo e($fase->fornitore_esterno ?? '-'); ?></td><?php endif; ?>
    <td class="descrizione td-descrizione"><?php echo e($fase->ordine->descrizione ?? '-'); ?></td>
    ...
    <td>
        <input type="number" min="0" style="width:70px; padding:2px 4px; font-size:13px; border:1px solid #ced4da; border-radius:3px;"
               value="<?php echo e($fase->qta_prod ?? ''); ?>"
               onchange="salvaQtaProd(<?php echo e($fase->id); ?>, this.value)"

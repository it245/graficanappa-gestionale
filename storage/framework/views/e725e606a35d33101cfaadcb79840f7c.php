...
<select id="filterFase" multiple>
    <?php $__currentLoopData = $fasiCatalogo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faseCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($faseCat->nome); ?>"><?php echo e($faseCat->nome); ?></option>

...
final class CommessaService
{
    ...
    public function aggiornaCampo(
        ...
        if (in_array($campo, $campiOrdine, true)) {
            ...
            // NB: descrizione NON propagata su altri ordini della stessa commessa.
            // Multi-modello (es. 6 PRD Onda con cod_art "Astucci") richiede
            // descrizioni distinte per lettera/variante. Modifica solo l'ordine
            // della fase corrente.

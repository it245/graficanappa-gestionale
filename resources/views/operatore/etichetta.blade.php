...
<div class="etichetta-preview" id="etichetta" @if($isSimpleLabel) style="justify-content: center;" @endif>
    ...
    <div style="margin-top: 22mm; margin-bottom: 5mm; font-size: 18pt; font-weight: bold; text-align: center; text-transform: uppercase;" id="print-descrizione-tifata">{{ $ordine->descrizione ?? '' }}</div>

...
.clock-date { font-size: 0.35rem; color: var(--text-muted); }
...
.m-ore { font-size: 0.38rem; color: var(--text-cliente); font-weight: 600; }
.m-bar { width: 3rem; height: 0.15rem; background: var(--border); border-radius: 0.1rem; margin-top: 0.1rem; margin-left: auto; }
.m-bar-fill { height: 100%; border-radius: 0.1rem; background: #38bdf8; }

/* === ZONA 2: PROSSIMI LAVORI === */
.z2 .zone-title { color: var(--text-cliente); }
...
.coda-macchina { font-size: 0.44rem; font-weight: 700; color: var(--text-muted); text-transform: uppercase; margin: 0.2rem 0 0.06rem; letter-spacing: 0.05em; }
...
.ore-nome { font-size: 0.54rem; font-weight: 600; color: var(--text-cliente); min-width: 5.5rem; }
.ore-bar { flex: 1; height: 0.6rem; background: var(--border); border-radius: 0.3rem; overflow: hidden; margin: 0 0.4rem; }
...
.solar-update { font-size: 0.36rem; color: var(--text-muted); }

.solar-kpis { display: flex; justify-content: center; gap: 2.5rem; margin-bottom: 1.2rem; }
.solar-kpi { text-align: center; background: var(--bg-macchina); padding: 0.8rem 1.5rem; border-radius: 0.5rem; min-width: 7rem; border: 1px solid #1e293b; }
.solar-kpi-val { font-size: 2.2rem; font-weight: 900; line-height: 1; }
.solar-kpi-unit { font-size: 0.5rem; color: var(--text-muted); font-weight: 600; margin-top: 0.1rem; }
.solar-kpi-lbl { font-size: 0.36rem; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.2rem; }

.solar-inverters { flex: 1; }
.solar-inv-title { font-size: 0.5rem; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.4rem; }
.solar-inv-row { display: flex; align-items: center; gap: 0.5rem; padding: 0.3rem 0.5rem; margin-bottom: 0.2rem; background: var(--bg-macchina); border-radius: 0.3rem; }
.solar-inv-row.offline { opacity: 0.35; }
.solar-inv-name { font-size: 0.5rem; font-weight: 700; color: var(--text); min-width: 3rem; }
.solar-inv-tipo { font-size: 0.4rem; color: var(--text-muted); min-width: 5rem; }
.solar-inv-kwp { font-size: 0.42rem; color: var(--text-cliente); min-width: 3.5rem; text-align: right; }
.solar-inv-bar { flex: 1; height: 0.55rem; background: var(--border); border-radius: 0.28rem; overflow: hidden; margin: 0 0.4rem; }
...
function toggleTheme() {
    ...
    document.getElementById('themeBtn').style.color = isDark ? '#fff' : '#fff';
}
// Carica tema salvato (default: chiaro)
(function() {

...
<div class="container-fluid mt-3 px-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('owner.dashboard') }}" class="btn btn-sm btn-outline-secondary">Torna alla Dashboard</a>
    </div>

    {{-- Filtri --}}
    <div class="card mb-3">
        <div class="card-body py-2">
            <form method="GET" action="{{ route('owner.storicoCommesse') }}" class="row g-2 align-items-end">
                {{-- Filtro stato --}}
                <div class="col-auto">
                    <label class="form-label mb-0" style="font-size:12px;">Stato</label>
                    <select name="stato" class="form-select form-select-sm" style="min-width:130px;">
                ...
                <div class="col-auto">
                    ...
                    <a href="{{ route('owner.storicoCommesse') }}" class="btn btn-sm btn-outline-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm table-striped mb-0" style="font-size:13px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('owner.dettaglioCommessa', $c->commessa) }}" style="color:#000; font-weight:bold; text-decoration:underline;">
                                    {{ $c->commessa }}
                                </a>
                            </td>

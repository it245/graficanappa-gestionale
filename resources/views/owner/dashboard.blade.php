        ...
        <table id="tabellaOrdini" class="table table-bordered table-sm table-striped" style="white-space:nowrap;">
            ...
            @foreach($fasi as $fase)
                ...
                <tr class="{{ $rowClass }}" data-id="{{ $fase->id }}">
                    ...
                    <td contenteditable onblur="aggiornaStato({{ $fase->id }}, this.innerText)" style="background:#d1fae5 !important;font-weight:bold;text-align:center;color:#065f46;font-size:10px;" title="DDT fornitore inviata">INVIATO</td>
                    @elseif($fase->esterno)

...
<div class="mes-sidebar-section">
    ...
    <a href="{{ route('magazzino.reso', ['op_token' => request('op_token')]) }}" class="mes-sidebar-item {{ request()->routeIs('magazzino.reso') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>
        Reso
    </a>
    <a href="{{ route('magazzino.rettifica', ['op_token' => request('op_token')]) }}" class="mes-sidebar-item {{ request()->routeIs('magazzino.rettifica') ? 'active' : '' }}">

...
<head>
    ...
    <title>Reset Password | MES Grafica Nappa</title>
...
<body>
    <div class="login-card">
        ...
        <p class="subtitle">Imposta una nuova password per il tuo account</p>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="field-group">
                ...
                <input id="email" type="email" name="email" value="{{ $email ?? old('email') }}"
                       placeholder="nome@graficanappa.com" required autofocus autocomplete="email">
            </div>
            <div class="field-group">
                <label for="password">Nuova password</label>
                <input id="password" type="password" name="password"
                       placeholder="&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;" required autocomplete="new-password">
            </div>
            <div class="field-group">
        ...
        <a href="{{ url('/login') }}" class="back-link">&larr; Torna al login</a>
    </div>
</body>
</html>
